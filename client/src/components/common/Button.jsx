...
// Purpose: Redesigned Button component with Framer Motion animations
// Design: Safety-first with warm, rounded corners and soft interactions
...
const Button = ({
  ...
  // Base styles: Rounded corners, smooth transitions, focus states
  ...
  // Variant styles: Each variant has warm colors and soft shadows
  const variants = {
  ...
  // Size variants: Large touch targets for accessibility (min 44x44px)
  const sizes = {
